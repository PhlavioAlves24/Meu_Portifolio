...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    video: VIDEO_B,
    poster: posterB,
    title: "Domus Legal — Advocacia",
    category: "Institucional",
    description:
      "Site institucional para escritório de advocacia, com apresentação das áreas de atuação, página de equipe e formulário de agendamento de consultas.",
    stack: ["Web Design", "UI Design", "Desenvolvimento", "SEO"],
    year: "2026",
  },
  {
    id: "p3",
    video: VIDEO_C,
    poster: posterC,
    title: "Barbearia Imperio Barber",
    category: "Site & Agendamento",
    description:
      "Site para barbearia com vitrine de cortes, tabela de serviços e agendamento direto pelo WhatsApp, reforçando a identidade visual da marca.",
    stack: ["Web Design", "UI Design", "Desenvolvimento", "Agendamento"],
    year: "2025",
  },
  {
    id: "p4",
    video: VIDEO_D,
    poster: posterD,
    title: "Protocolo Referencia",
    category: "Landing Page",
    description:
      "Landing page de apresentação do método Protocolo Referencia, com narrativa persuasiva, prova social e chamadas estrategicamente posicionadas para gerar contatos.",
    stack: ["Web Design", "Copy & Conversão", "Desenvolvimento", "Landing Page"],
    year: "2026",
  },
];
